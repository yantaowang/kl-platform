package com.kl.common.constants;

public class CommonConstants {

    public static String BASE_PACKAGE_NAME = "com.kl";

    public static final String GET_MODE_SPEL = "#{'${EWP_PROFILE:}'.trim().isEmpty() ? '${spring.profiles.active}' : '${EWP_PROFILE:}'}";
