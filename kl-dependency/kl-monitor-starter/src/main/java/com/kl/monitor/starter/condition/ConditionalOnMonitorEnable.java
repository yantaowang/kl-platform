...
@Documented
@Conditional(MonitorEnableCondition.class)
public @interface ConditionalOnMonitorEnable {

	/**
	 * The name of the monitor include.
	 * @return the name of the monitor include
	 */
	String[] value();
